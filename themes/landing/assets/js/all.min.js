...
document.addEventListener("DOMContentLoaded", function () {
  ...
  new Splide(".splide_in", {
    type: "fade",
    rewind: !0
  }).mount();
}), $(".popupOpen-btn").click(function () {
  $(".popup").addClass("popup__active"), $("body").addClass("stop-scrolling");
}), $(".popup__cancelbtn").click(function () {
  $(".popup").removeClass("popup__active"), $("body").removeClass("stop-scrolling");
}), $(function () {
  AOS.init({
    offset: 100,
    duration: 700,
  ...
  function $($, n) {
    ...
    var e,
        t = d;
    $[0] in t || void 0 === t.execScript || t.execScript("var " + $[0]);

    for (; $.length && (e = $.shift());) {
      $.length || void 0 === n ? t = t[e] && t[e] !== Object.prototype[e] ? t[e] : t[e] = {} : t[e] = n;
    }
  }
  ...
  function n(d, $) {
    ...
    n.prototype = $.prototype, d.$ = $.prototype, d.prototype = new n(), d.prototype.constructor = d, d.fa = function (d, n, e) {
      for (var t = Array(arguments.length - 2), r = 2; r < arguments.length; r++) {
        t[r - 2] = arguments[r];
      }

      return $.prototype[n].apply(d, t);
    };
  }
  ...
  function t(d, $) {
    switch (this.g = d, this.m = !!$.o, this.i = $.h, this.v = $.type, this.u = !1, this.i) {
      case u:
      case o:
      case l:
      case a:
  ...
  function h(d, $, n) {
    var e = g(d, $);
    return d.l[$].m ? e[n || 0] : e;
  }

  function C(d, $) {
    if (null != d.g[$]) d = h(d, $, void 0);else d: {
      if (void 0 === (d = d.l[$]).l) if (($ = d.v) === Boolean) d.l = !1;else if ($ === Number) d.l = 0;else {
        if ($ !== String) {
          d = new $();
          break d;
        }
  ...
  c.prototype.has = function (d) {
    ...
    return d != this && (d.g = {}, d.i && (d.i = {}), function d($, n) {
      for (var e = p($.j()), t = 0; t < e.length; t++) {
        var r = e[t],
            i = r.g;
        ...
        if (null != n.g[i]) {
          ...
          } else r = g(n, i), u ? (u = g($, i)) ? d(u, r) : M($, i, r.clone()) : M($, i, r);
        }
      }
    }(d, this)), d;
  }, A.prototype.g = function (d) {
    throw new d.i(), Error("Unimplemented");
  }, A.prototype.i = function (d, $) {
    if (11 == d.i || 10 == d.i) return $ instanceof c ? $ : this.g(d.v.prototype.j(), $);
    if (14 == d.i) return "string" == typeof $ && E.test($) && 0 < (d = Number($)) ? d : $;
    if (!d.u) return $;

    if ((d = d.v) === String) {
      if ("number" == typeof $) return String($);
    } else if (d === Number && "string" == typeof $ && ("Infinity" === $ || "-Infinity" === $ || "NaN" === $ || E.test($))) return Number($);
  ...
  n(N, A), N.prototype.g = function (d, $) {
    return (d = new d.i()).m = this, d.g = $, d.i = {}, d;
  }, n(I, N), I.prototype.i = function (d, $) {
    return 8 == d.i ? !!$ : A.prototype.i.apply(this, arguments);
  }, I.prototype.g = function (d, $) {
    return I.$.g.call(this, d, $);
  }, G.prototype.i = "", G.prototype.set = function (d) {
    this.i = "" + d;
  }, G.prototype.g = function (d, $, n) {
    if (this.i += String(d), null != $) for (var e = 1; e < arguments.length; e++) {
      this.i += arguments[e];
    }
    return this;
  ...
  }, _.j = _.prototype.j, v.prototype.j = function () {
    var d = L;
    return d || (L = d = T(v, {
      0: {
  ...
  }, v.j = v.prototype.j, B.prototype.j = function () {
    var d = R;
    return d || (R = d = T(B, {
      0: {
        name: "PhoneMetadata",
  ...
  }, O.ctor = O, O.ctor.j = O.prototype.j;
  var U = {
  ...
  var Q = new RegExp("(?:" + X() + ")$", "i"),
      k = new RegExp("^[0-9０-９٠-٩۰-۹]{2}$|^[+＋]*(?:[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*]*[0-9０-９٠-٩۰-۹]){3,}[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*A-Za-z0-9０-９٠-٩۰-۹]*(?:" + X() + ")?$", "i"),
      q = /(\$\d)/;

  function z(d) {
    return !(2 > d.length) && yd(k, d);
  }

  function dd(d) {
    return yd(J, d) ? ed(d, V) : ed(d, F);
  }
  ...
  function nd(d) {
    return null != d && (1 != m(d, 9) || -1 != S(d, 9)[0]);
  }

  function ed(d, $) {
    for (var n, e = new G(), t = d.length, r = 0; r < t; ++r) {
      null != (n = $[(n = d.charAt(r)).toUpperCase()]) && e.g(n);
    }
  ...
  function td(d) {
    return null != d && isNaN(d) && d.toUpperCase() in D;
  }
  ...
  function rd(d, $, n) {
    ...
    e = C($, 1);
    var t = ud($);
    if (0 == n) return od(e, 0, t, "");
    if (!(e in U)) return t;
    d = id(d, e, cd(e)), $ = null != $.g[3] && 0 != h($, 3).length ? 3 == n ? ";ext=" + h($, 3) : null != d.g[13] ? h(d, 13) + C($, 3) : " ext. " + C($, 3) : "";

    d: {
      for (var r, i = (d = 0 == S(d, 20).length || 2 == n ? S(d, 19) : S(d, 20)).length, u = 0; u < i; ++u) {
        var o = m(r = d[u], 3);

        if ((0 == o || 0 == t.search(h(r, 3, o - 1))) && yd(o = new RegExp(h(r, 1)), t)) {
          d = r;
          break d;
        }
      }
    ...
    return null != d && (d = C(i = d, 2), r = new RegExp(h(i, 1)), C(i, 5), i = C(i, 4), t = 2 == n && null != i && 0 < i.length ? t.replace(r, d.replace(q, i)) : t.replace(r, d), 3 == n && (t = (t = t.replace(/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/, "")).replace(/[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/g, "-"))), od(e, n, t, $);
  }
  ...
  function ud(d) {
    ...
    var $ = "" + h(d, 2);
    return null != d.g[4] && h(d, 4) && 0 < C(d, 8) ? Array(C(d, 8) + 1).join("0") + $ : $;
  }
  ...
  function ad(d, $) {
    return sd(d, h($, 1)) ? sd(d, h($, 5)) ? 4 : sd(d, h($, 4)) ? 3 : sd(d, h($, 6)) ? 5 : sd(d, h($, 8)) ? 6 : sd(d, h($, 7)) ? 7 : sd(d, h($, 21)) ? 8 : sd(d, h($, 25)) ? 9 : sd(d, h($, 28)) ? 10 : sd(d, h($, 2)) ? h($, 18) || sd(d, h($, 3)) ? 2 : 0 : !h($, 18) && sd(d, h($, 3)) ? 1 : -1 : -1;
  }
  ...
  function sd(d, $) {
    var n = d.length;
    return !(0 < m($, 9) && -1 == S($, 9).indexOf(n)) && yd(C($, 2), d);
  }

  function pd(d, $) {
    if (null == $) return null;
    var n = C($, 1);
    if (null == (n = U[n])) d = null;else if (1 == n.length) d = n[0];else d: {
      $ = ud($);
  ...
  function cd(d) {
    return null == (d = U[d]) ? "ZZ" : d[0];
  }

  function gd(d, $, n, e) {
    var t = ld(n, e),
        r = 0 == m(t, 9) ? S(h(n, 1), 9) : S(t, 9);

    if (t = S(t, 10), 2 == e) {
      if (!nd(ld(n, 0))) return gd(d, $, n, 1);
      nd(d = ld(n, 1)) && ((r = r.concat(0 == m(d, 9) ? S(h(n, 1), 9) : S(d, 9))).sort(), 0 == t.length ? t = S(d, 10) : (t = t.concat(S(d, 10))).sort());
    }

    return -1 == r[0] ? 5 : ($ = $.length, -1 < t.indexOf($) ? 4 : (n = r[0]) == $ ? 0 : n > $ ? 2 : r[r.length - 1] < $ ? 3 : -1 < r.indexOf($, 1) ? 0 : 5);
  }

  function hd(d, $) {
    var n = ud($);
    return ($ = C($, 1)) in U ? gd(d, n, $ = id(d, $, cd($)), -1) : 1;
  }

  function Cd(d, $, n, e, t, r) {
    if (0 == $.length) return 0;
    var i;
    $ = new G($), null != n && (i = h(n, 11)), null == i && (i = "NonMatch");
    var u = $.toString();
    if (0 == u.length) i = 20;else if (x.test(u)) u = u.replace(x, ""), $.i = "", $.g(dd(u)), i = 1;else {
      if (u = new RegExp(i), $d($), 0 == (i = $.toString()).search(u)) {
        u = i.match(u)[0].length;
        var o = i.substring(u).match(H);
        o && null != o[1] && 0 < o[1].length && "0" == ed(o[1], F) ? i = !1 : ($.i = "", $.g(i.substring(u)), i = !0);
      } else i = !1;
    ...
    if (t && M(r, 6, i), 20 != i) {
      if (2 >= $.i.length) throw Error("Phone number too short after IDD");

      d: {
        if (0 != (d = $.toString()).length && "0" != d.charAt(0)) for (t = d.length, $ = 1; 3 >= $ && $ <= t; ++$) {
          if ((n = parseInt(d.substring(0, $), 10)) in U) {
            e.g(d.substring($)), e = n;
            break d;
          }
        }
      ...
      if (0 != e) return M(r, 1, e), e;
      throw Error("Invalid country calling code");
    }

    return null != n && (u = "" + (i = C(n, 10)), 0 == (o = $.toString()).lastIndexOf(u, 0) && (u = new G(o.substring(u.length)), o = h(n, 1), o = new RegExp(C(o, 2)), Sd(u, n, null), u = u.toString(), !yd(o, $.toString()) && yd(o, u) || 3 == gd(d, $.toString(), n, -1))) ? (e.g(u), t && M(r, 6, 10), M(r, 1, i), i) : (M(r, 1, 0), 0);
  }
  ...
  function Sd(d, $, n) {
    ...
    if (0 != t && null != r && 0 != r.length) {
      var i = new RegExp("^(?:" + r + ")");

      if (t = i.exec(e)) {
        var u = yd(r = new RegExp(C(h($, 1), 2)), e),
            o = t.length - 1;
        null == ($ = h($, 16)) || 0 == $.length || null == t[o] || 0 == t[o].length ? u && !yd(r, e.substring(t[0].length)) || (null != n && 0 < o && null != t[o] && n.g(t[1]), d.set(e.substring(t[0].length))) : (e = e.replace(i, $), (!u || yd(r, e)) && (null != n && 0 < o && n.g(t[1]), d.set(e)));
      }
    }
  }

  function md(d, $, n) {
    if (!td(n) && 0 < $.length && "+" != $.charAt(0)) throw Error("Invalid country calling code");
    return Md(d, $, n, !0);
  }
  ...
  function Md(d, $, n, e) {
    ...
    if (0 <= r) {
      ...
      if ("+" == $.charAt(i)) {
        var u = $.indexOf(";", i);
        0 < u ? t.g($.substring(i, u)) : t.g($.substring(i));
      }

      i = $.indexOf("tel:"), t.g($.substring(0 <= i ? i + 4 : 0, r));
    } else r = t.g, 0 <= (i = $.search(Z)) ? 0 <= (u = (i = (i = $.substring(i)).replace(Y, "")).search(W)) && (i = i.substring(0, u)) : i = "", r.call(t, i);

    if (0 < (i = (r = t.toString()).indexOf(";isub=")) && (t.i = "", t.g(r.substring(0, i))), !z(t.toString())) throw Error("The string supplied did not seem to be a phone number");
    if (r = t.toString(), !(td(n) || null != r && 0 < r.length && x.test(r))) throw Error("Invalid country calling code");
    r = new O(), e && M(r, 5, $);

    d: {
      if (0 <= (i = ($ = t.toString()).search(Q)) && z($.substring(0, i))) for (var o = (u = $.match(Q)).length, l = 1; l < o; ++l) {
        if (null != u[l] && 0 < u[l].length) {
          t.i = "", t.g($.substring(0, i)), $ = u[l];
          break d;
        }
      }
      $ = "";
    ...
    0 < $.length && M(r, 3, $), i = fd(d, n), $ = new G(), u = 0, o = t.toString();

    try {
      u = Cd(d, o, i, $, e, r);
    } catch (n) {
      if ("Invalid country calling code" != n.message || !x.test(o)) throw n;
      if (0 == (u = Cd(d, o = o.replace(x, ""), i, $, e, r))) throw n;
    }

    if (0 != u ? (t = cd(u)) != n && (i = id(d, u, t)) : ($d(t), $.g(t.toString()), null != n ? M(r, 1, u = C(i, 10)) : e && (delete r.g[6], r.i && delete r.i[6])), 2 > $.i.length) throw Error("The string supplied is too short to be a phone number");
    if (null != i && (n = new G(), Sd(t = new G($.toString()), i, n), 2 != (d = gd(d, t.toString(), i, -1)) && 4 != d && 5 != d && ($ = t, e && 0 < n.toString().length && M(r, 7, n.toString()))), 2 > (d = (e = $.toString()).length)) throw Error("The string supplied is too short to be a phone number");
    if (17 < d) throw Error("The string supplied is too long to be a phone number");

    if (1 < e.length && "0" == e.charAt(0)) {
      for (M(r, 4, !0), d = 1; d < e.length - 1 && "0" == e.charAt(d);) {
        d++;
      }
  ...
  $("intlTelInputUtils", {}), $("intlTelInputUtils.formatNumber", function (d, $, n) {
    try {
      var e = w.g(),
          t = md(e, d, $),
          r = hd(e, t);
      return 0 == r || 4 == r ? rd(e, t, void 0 === n ? 0 : n) : d;
    } catch ($) {
      return d;
    }
  }), $("intlTelInputUtils.getExampleNumber", function (d, $, n) {
    try {
      var e = w.g();
  ...
  }), $("intlTelInputUtils.getExtension", function (d, $) {
    try {
      return h(md(w.g(), d, $), 3);
    } catch (d) {
      return "";
    }
  }), $("intlTelInputUtils.getNumberType", function (d, $) {
    try {
      var n = w.g(),
          e = md(n, d, $),
          t = pd(n, e),
          r = id(n, C(e, 1), t);
      if (null == r) var i = -1;else i = ad(ud(e), r);
      return i;
    } catch (d) {
      return -99;
    }
  }), $("intlTelInputUtils.getValidationError", function (d, $) {
    try {
      var n = w.g();
      return hd(n, md(n, d, $));
    } catch (d) {
  ...
  }), $("intlTelInputUtils.isValidNumber", function (d, $) {
    try {
      var n,
          e = w.g(),
          t = md(e, d, $),
      ...
      if (n) var a = !1;else a = -1 != ad(ud(t), u);
      return a;
    } catch (d) {
      return !1;
    }
